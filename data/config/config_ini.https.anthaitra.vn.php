...
$sys_info['server_headers'] = ['content-type' => 'text/html; charset=UTF-8','keep-alive' => 'timeout=120','vary' => 'Accept-Encoding','server' => 'Apache','x-content-type-options' => 'nosniff'];
